...
def main():
    ...
    trie = load_words_from_file(FILE_PATH)     # You are allowed to change returned variables here. Still, you need to change correspondingly the unit test by yourself.
    ...
    while True:
        ...
        if keywords.lower() == 'quit':
            break
        results = search(keywords, trie)       # You are allowed to change returned variables here. Still, you need to change correspondingly the unit test by yourself.
        print(results)
